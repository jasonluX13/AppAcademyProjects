...
<asp:Repeater ID="Librarians" runat="server" ItemType="DataRow">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <asp:HyperLink runat="server" class="btn btn-secondary" NavigateUrl='<%# $"~/EditLibrarian.aspx?ID={Item.Field<int>("Id")}" %>' Text="Edit" visible='<%# Item.Field<int>("LibraryCardNumber") == LibraryCardNumber %>'/></td>
        </tr>
    </ItemTemplate>
    <FooterTemplate>
        </tbody>
