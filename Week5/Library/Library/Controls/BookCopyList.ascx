...
<asp:Button ID="ListModeButton" cssclass="btn btn-light" runat="server" Text="List All" onclick="ListMode_Click"/>
<asp:Repeater ID="BookCopies" runat="server" ItemType="DataRow">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td>
                <asp:HyperLink runat="server" class="btn btn-secondary" NavigateUrl='<%# $"~/EditBookCopy.aspx?ID={Item.Field<int>("Id")}" %>' Text="Edit" Visible='<%# CustomUser.IsLibrarian %>'/></td>
            <td>
